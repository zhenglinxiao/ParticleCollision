...
public class QuantumFormulas {
    ...
    public static double getGamma(Particle p) {
        double velocity = PhysicsFormulas.scale(p.getVelocity().magnitude());
